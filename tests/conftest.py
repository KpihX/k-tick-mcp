...
from k_tick_mcp.config import ENV_API_TOKEN, ENV_SESSION_TOKEN, ENV_USERNAME, ENV_PASSWORD


# ─── Paths ────────────────────────────────────────────────────────────────────
PACKAGE_DIR = Path(__file__).resolve().parent.parent / "src" / "k_tick_mcp"
...
def require_api_token():
    ...
    from k_tick_mcp.config import _shell_read_env
